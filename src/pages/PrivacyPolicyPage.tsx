...
const sections = [
  {
    ...
    content: [
      'Mijn Diddl is verantwoordelijk voor de verwerking van uw persoonsgegevens zoals beschreven in dit privacybeleid.',
  ...
  },
  {
    ...
    content: [
      ...
      'Betaalkaartgegevens worden nooit opgeslagen door Mijn Diddl. Alle betalingen worden volledig afgehandeld door iCEPAY (PCI-DSS gecertificeerd). Wij ontvangen uitsluitend een bevestiging van de geslaagde betaling.',
  ...
  },
  {
    title: '6. Beveiliging',
    content: [
      'Mijn Diddl neemt passende technische en organisatorische maatregelen om uw persoonsgegevens te beschermen tegen verlies, onbevoegde toegang of misbruik:',
...
export default function PrivacyPolicyPage() {
  return (
    <>
      <Helmet>
        <title>Privacybeleid | Mijn Diddl</title>
        <meta
          name="description"
          content="Lees hoe Mijn Diddl omgaat met uw persoonsgegevens, welke gegevens wij verwerken en wat uw rechten zijn onder de AVG."
        />
      ...
      <div className="pt-20">
        ...
        <section className="max-w-3xl mx-auto px-6 py-20">
          <p className="font-sans text-sm text-violet leading-relaxed mb-12">
